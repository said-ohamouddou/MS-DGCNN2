"""Point-M2AE pre-training module. Official repo: https://github.com/zrrskywalker/point-m2ae (MIT)."""
import torch
...
from ..base_model import print_model_info
import random
...
class PointM2AE_Pretrain(nn.Module):

    def __init__(self, config):
        super().__init__()
        print_model_info(config, mode='pretrain')
    ...
    def forward(self, pts, eval=False, noaug=False, **kwargs):
